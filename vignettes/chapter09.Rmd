---
title: "Additional Topics for Factorial and Fractional Factorial Designs"
output: rmarkdown::html_vignette
bibliography: bibliography.bib
vignette: >
  %\VignetteIndexEntry{Chapter 09 - Additional Designs and Analysis Topics for Factorial and Fractional Factorial Designs}
...
At present there's no easy way to construct $I$-optimal designs with blocks using R.  We will construct an I-optimal design for 6 factors at levels $(-1, 0, 1)$. The design from the text has balanced blocks with three runs in each block, but the `AlgDesign` package does not support this constraint for $I$-optimal designs.
...
The optimal design discovered has I-criterion `r opt.i$I` and the following layout.
