---
title: "Robust Parameter Design and Process Robustness Studies"
output: rmarkdown::html_vignette
bibliography: bibliography.bib
vignette: >
  %\VignetteIndexEntry{Chapter 12 - Robust Parameter Design and Process Robustness Studies}
...
Recall the filtration experiment from Example 6.2.  Assume that temperature (`z`) is difficult to control, while pressure (`x1`), concentration (`x2`), and stirring rate (`x3`) are easy to control. 
```{r}
df <- Table6.10
...
Consider the semiconductor manufacturing experiment data in Table 12.3.
```{r}
df <- Table12.3[,-1]
